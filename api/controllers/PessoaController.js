...
class PessoaController {
  ...
  static async restauraMatricula(req, res) {
    ...
    try {
      ...
      return res.status(200).json({ mensagem: `Matricula ${matriculaId} foi restaurado.`})
  ...
  static async cancelaPessoa(req, res) {
    ...
    try {
      ...
      return res.status(200).json({ message: `Matrículas referente ao estudante ${estudanteId} foi canceladas.`}) 
      })
